...
const teamData = {
    ...
    50: {
        ...
        image: "images/committee/richard2.jpeg",
    },
    ...
    59:{
        ...
        image:"images/committee/Dr-Uday-Singh_-_Uday_Pratap_Singh.png",
    },
    60:{
    ...
    72:{
        ...
        info: "Dr. Ram Bilas Pachori is a professor and researcher at IIT Indore (Indian Institute of Technology Indore), specializing in areas such as signal processing, biomedical engineering, and machine learning. His work primarily focuses on the application of advanced computational techniques in healthcare, particularly in biomedical signal analysis and brain-computer interfacing. At IIT Indore, Dr. Pachouri's research may include developing algorithms for analyzing complex biomedical signals like EEG (electroencephalogram) and ECG (electrocardiogram), which are used for diagnosing neurological and cardiovascular disorders. His expertise in signal processing allows him to extract meaningful information from these signals, improving diagnostic accuracy and advancing technologies in non-invasive medical diagnostics. Dr. Pachouri also likely collaborates on interdisciplinary projects that combine machine learning and artificial intelligence with biomedical applications. This could involve designing systems for real-time health monitoring, enhancing medical imaging techniques, or developing models for predictive healthcare. In addition to his research, Dr. Pachouri is likely involved in teaching and mentoring students, supervising Ph.D. candidates, and publishing extensively in reputed scientific journals. His work bridges the gap between engineering and medicine, contributing to innovations in health technology that can improve patient care and healthcare outcomes.",
    ...
    76:{
        name:"Mr. Naimil Gadani",
        info: "Mr. Naimil Gadani, a distinguished technology leader from Houston, Texas, USA - with over a decade of professional experience in crafting innovative web and mobile enterprise applications. His extensive expertise spans cutting-edge domains, including Artificial Intelligence (AI), Machine Learning (ML), Serverless Computing, and Microservices Architecture, making him a key figure in advancing technology solutions across industries. \nNaimil holds a Master of Science in Information Systems from the University of Houston-Clear Lake and a Bachelor of Engineering in Information Technology from Gujarat University. His academic foundation is complemented by an impressive array of certifications, including Microsoft Certified Application Developer, Oracle Certified Associate, and Cisco Certified Network Associate.\n Currently, Naimil plays a critical role in public-sector technology, notably developing and managing the AWS Cloud Architecture. He also spearheaded the design of the Electronic Pollbook Solution (ePollbooks), which transformed voter registration processes and enhanced election efficiency.\n Beyond his technical acumen, Naimil has a proven track record as a mentor and leader, driving innovation and collaboration within his teams. His contributions extend to the global tech community, where he actively engages in knowledge sharing and strategic initiatives to push the boundaries of technology.\n In addition to his professional achievements, Naimil is an active Senior member of prominent organizations, including the IEEE (Institute of Electrical and Electronics Engineers), Fellow Member - British Computer Society, Fellow Member - The Institution of Electronics and Telecommunication Engineers (IETE).",
        image:"images/committee/naimil-gadani\ \(1\).png",
    },
    77:{
        name:"Mr. Anurag Basani",
        info: "Anurag Basani is a seasoned data analytics leader with over a decade of experience in Data Engineering, Data Warehousing, Business Intelligence, and Big Data. He has successfully navigated diverse industries, including Insurance, Financial, Government, and Technology, enhancing data-driven decision-making processes. Anurag is passionate about understanding the evolving data analytics needs of organizations and building scalable data solutions that deliver actionable insights. He has led initiatives that optimize data processes, architect robust data infrastructures, and implement innovative solutions to drive organizational success. As a data enthusiast, Anurag excels in unraveling complex data ecosystems and crafting solutions that empower businesses in an information-driven era. His expertise lies in architecting scalable data solutions, building robust infrastructures, and enabling analytics at scale. Currently, at Meta, Anurag focuses on transforming enterprise data services by architecting and building scalable pipelines and metrics. These efforts provide insights into compliance, mitigate risks, and offer critical insights into business operations.",
        image:"images/committee/anurag-basani.jpg",
    }
  };
